let musicDB = [
    {
        ...
        musicName: "kill.mp3",
        attribution: {
            song: "Pvnthera WWW - Kill Freestyle",
            musicBy: "Pvnthera WWW",
            download: null,
            stream: null
        }
    },
    {
        ...
        musicName: "bomj.mp3",
        attribution: {
            song: "Pvnthera WWW - Bomj Freestyle",
            musicBy: "Pvnthera WWW",
            download: null,
            stream: null
        }
    ...
    {
        id: 2,
        name: "Telephone Freestyle",
        author_name: "Pvnthera WWW",
        img: "song-1.jpg",
        lang: "ENGLISH",
        type: "electronic",
        timesPlayed: 0,
        musicName: "telephone.mp3",
        attribution: {
            song: "Pvnthera WWW - Telephone Freestyle",
            musicBy: "Pvnthera WWW",
            download: null,
            stream: null
        }
    },
    {
        id: 3,
        name: "Pvnthera WWW",
        author_name: "Darkwwwater",
        img: "song-1.jpg",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "blackwwwater.mp3",
        attribution: {
            song: "Pvnthera WWW - Darkwwwater",
            musicBy: "Pvnthera WWW",
            download: null,
            stream: null
        }
