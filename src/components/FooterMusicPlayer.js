...
import {setBannerOpen, setCurrentPlaying} from "./actions";
...
function FooterMusicPlayer({music}) {
    ...
    return (
        <div style={useStyle.component} className={"footer-player"}>
            ...
            <Button
                    startIcon={<Avatar variant="square" src={require("../components/assets/img/" + img).default} alt={name}/>}
            ...
            <div className="playback-controls">
                ...
                <audio ref={audioElement} src={require("../components/assets/music/" + musicName).default} preload={"metadata"}/>
